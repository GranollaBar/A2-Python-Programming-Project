...
class CoachingSessionContent:
	...
	def __init__(self, mainScreen):
		...
		self.conn = sqlite3.connect('Badmington_club.db')
	...
	def generateContnt(self):
		...
		def courtsRequired():
			courts = Toplevel(self.member, bg="white")
		...
		def groupsRequired():
			groups = Toplevel(self.member, bg="white")
		...
		starttime_label = tkinter.Label(self.member, text="Start Time:", font=('Tahoma', 14, 'bold'), fg='black', bg='white')
		starttime_label.place(rely=0.47, relx=0.12, anchor='center')

		endtime_label = tkinter.Label(self.member, text="End Time:", font=('Tahoma', 14, 'bold'), fg='black', bg='white')
		endtime_label.place(rely=0.56, relx=0.12, anchor='center')

		date_label = tkinter.Label(self.member, text="Session Date:", font=('Tahoma', 14, 'bold'), fg='black', bg='white')
		date_label.place(rely=0.65, relx=0.12, anchor='center')

		courts_needed_label = tkinter.Label(self.member, text="Courts Required:", font=('Tahoma', 14, 'bold'), fg='black', bg='white')
		courts_needed_label.place(rely=0.74, relx=0.12, anchor='center')

		level_label = tkinter.Label(self.member, text="Group Level:", font=('Tahoma', 14, 'bold'), fg='black', bg='white')
		level_label.place(rely=0.83, relx=0.12, anchor='center')



		starttime_spinbox = Spinbox(self.member, width=7,font=("Tahoma",12, 'bold'), bd=3, relief='ridge', cursor="tcross",textvariable=timeStart, values=('8.00', '8.15', '8.30', '8.45', '9.00', '9.15', '9.30', '9.45', '10.00', '10.15', '10.30', '10.45', '11.00', '11.15', '11.30', '11.45', '12.00', '12.15','12.30','12.45','13.00','13.15','13.30','13.45','14.00','14.15','14.30','14.45','15.00','15.15','15.30','15.45','16.00','16.15','16.30','16.45','17.00','17.15','17.30','17.45','18.00','18.15','18.30','18.45','19.00','19.15','19.30','19.45','20.00','20.15','20.30','20.45','21.00','21.15','21.30','21.45','22.00'))
		starttime_spinbox.place(rely=0.4725, relx=0.3, anchor='center')

		endtime_spinbox = Spinbox(self.member, width=7,font=("Tahoma",12, 'bold'), bd=3, relief='ridge', cursor="tcross", textvariable=timeEnd, values=('9.00', '9.15', '9.30', '9.45', '10.00', '10.15', '10.30', '10.45', '11.00', '11.15', '11.30', '11.45', '12.00', '12.15','12.30','12.45','13.00','13.15','13.30','13.45','14.00','14.15','14.30','14.45','15.00','15.15','15.30','15.45','16.00','16.15','16.30','16.45','17.00','17.15','17.30','17.45','18.00','18.15','18.30','18.45','19.00','19.15','19.30','19.45','20.00','20.15','20.30','20.45','21.00','21.15','21.30','21.45','22.00','22.15','22.30','22.45','23.00'))
		endtime_spinbox.place(rely=0.5625, relx=0.3, anchor='center')

		date_entry = Button(self.member, text='Select Date',font=("Tahoma",11, 'bold'), cursor="tcross",command=lambda : dateEntryCheck(eventDate), padx=10, bd=4, relief="ridge")
		date_entry.place(rely=0.653, relx=0.3, anchor='center')

		courts_needed_button = Button(self.member, text='Select Courts',font=("Tahoma",11, 'bold'), cursor="tcross",command=lambda : courtsRequired(), padx=10, bd=4, relief="ridge")
		courts_needed_button.place(rely=0.743, relx=0.3, anchor='center')

		groups_needed_button = Button(self.member, text='Select Groups',font=("Tahoma",11, 'bold'), cursor="tcross",command=lambda : groupsRequired(), padx=10, bd=4, relief="ridge")
		groups_needed_button.place(rely=0.833, relx=0.3, anchor='center')

		delete_button = tkinter.Button(self.member, text="Delete", command=deleteSession, fg='white', bg='black', bd=4, relief='ridge', font=('Tahoma', 14, 'bold'), padx=10, cursor="tcross")
		delete_button.place(rely=0.94, relx=0.07, anchor='center')

		update_button = tkinter.Button(self.member, text="Update", command=updateSession, fg='white', bg='black', bd=4, relief='ridge', font=('Tahoma', 14, 'bold'), padx=10, cursor="tcross")
		update_button.place(rely=0.94, relx=0.21, anchor='center')

		submit_button = tkinter.Button(self.member, text="Submit", command=submitSession, fg='white', bg='black', bd=4, relief='ridge', font=('Tahoma', 14, 'bold'), padx=10, cursor="tcross")
		submit_button.place(rely=0.94, relx=0.35, anchor='center')


		coach_search_Tv=ttk.Treeview(self.member,height=4,columns=('Start Time','End Time','Date','Courts','Groups','No. People','Recurrence'))
		...
		coach_ysearch_scrollbar = Scrollbar(self.member, orient = 'vertical', command = coach_search_Tv.yview, cursor="tcross")
		...
		cal = Calendar(self.member, font="Tahoma 19", selectmode='day', cursor="tcross", year=2021, month=5, day=29)
	...
	def coachSelection(self):
		...
		if (len(coach_name_choices) > 0) :
			coach_selection_dropdown = OptionMenu(member, self.coachNamesAndPasswords, *coach_name_choices)
