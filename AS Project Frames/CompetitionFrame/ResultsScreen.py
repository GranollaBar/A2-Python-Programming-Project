...
class ResultsContent:
	...
	def generateResultsContnt(self):
		...
		def startDateCheck(dob):
			...
			start_cal = Calendar(startDateTop, font="Tahoma 16", date_pattern='dd/mm/yyyy',selectmode='day', cursor="tcross", year=2021, month=5, day=29)
		...
		def endDateCheck(dob):
			...
			end_cal = Calendar(endDateTop, font="Tahoma 16", date_pattern='dd/mm/yyyy',selectmode='day', cursor="tcross", year=2021, month=5, day=29)
		...
		confirm_group_button.place(rely=0.163, relx=0.86, anchor='center')

		complete_competition_button = tkinter.Button(self.results, cursor="tcross",text="Complete Competition", command=completeCompetition, fg='white', bg='black', bd=4, relief='ridge', font=('Tahoma', 10, 'bold'), padx=5, pady=8)
	...
	def memberSelection(self):
		...
		if (len(member_name_choices) > 0) :
			member_selection_dropdown = OptionMenu(self.results, self.memberNamesAndPasswords, *member_name_choices)
			member_selection_dropdown.place(rely=0.164, relx=0.255, anchor='center')

			member2_selection_dropdown = OptionMenu(self.results, self.memberNamesAndPasswords2, *member_name_choices)
			member2_selection_dropdown.place(rely=0.244, relx=0.255, anchor='center')
